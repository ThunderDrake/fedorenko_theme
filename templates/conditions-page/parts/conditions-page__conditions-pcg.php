...
$faq_btn = get_sub_field('faq_btn', 'option');
$faq_url = get_sub_field('faq_url', 'option');
...
<section class="conditions-pcg">
    ...
    <div class="container conditions-pcg__container">
      <?php
        if ($faq_image_id) {
          ...
          <picture>
            ...
            <img loading="lazy" src="<?php echo wp_get_attachment_image_url($faq_image_id, 'full'); ?>" class="conditions-pcg__pic" width="1575" height="400"
              alt="красивые столы">
        </picture>
      <?php } ?>
      ...
      <?php
        if ($faq_url) { ?>
          <a href="<?php echo $faq_url ?>" class="team__button button button--no-fill">
            <?php }
        else {?>
